...
# require export PYTHONPATH="$PYTHONPATH:/path/to/models/research/slim"
...
ConvTowerParams = collections.namedtuple('ConvTowerParams', ['final_endpoint', 'is_training'])
...
class Model(object):
  ...
  def default_mparams(self):
    return {
      'conv_tower_fn':
        ConvTowerParams(final_endpoint='Mixed_5d', is_training=True),
      'sequence_logit_fn':
